...
impl From<u8> for MouseButton {
  fn from(button_byte: u8) -> Self {
    match u32::from(button_byte) {
      fermium::SDL_BUTTON_LEFT => MouseButton::Left,
      fermium::SDL_BUTTON_MIDDLE => MouseButton::Middle,
      fermium::SDL_BUTTON_RIGHT => MouseButton::Right,
      fermium::SDL_BUTTON_X1 => MouseButton::X1,
      fermium::SDL_BUTTON_X2 => MouseButton::X2,
...
impl TryFrom<fermium::SDL_Scancode> for Scancode {
  ...
  fn try_from(t: fermium::SDL_Scancode) -> Result<Self, Self::Error> {
    match t {
      fermium::SDL_SCANCODE_0 => Ok(Scancode::_0),
      fermium::SDL_SCANCODE_1 => Ok(Scancode::_1),
      fermium::SDL_SCANCODE_2 => Ok(Scancode::_2),
      fermium::SDL_SCANCODE_3 => Ok(Scancode::_3),
      fermium::SDL_SCANCODE_4 => Ok(Scancode::_4),
      fermium::SDL_SCANCODE_5 => Ok(Scancode::_5),
      fermium::SDL_SCANCODE_6 => Ok(Scancode::_6),
      fermium::SDL_SCANCODE_7 => Ok(Scancode::_7),
      fermium::SDL_SCANCODE_8 => Ok(Scancode::_8),
      fermium::SDL_SCANCODE_9 => Ok(Scancode::_9),
      fermium::SDL_SCANCODE_A => Ok(Scancode::A),
      fermium::SDL_SCANCODE_AC_BACK => Ok(Scancode::AC_Back),
      fermium::SDL_SCANCODE_AC_BOOKMARKS => Ok(Scancode::AC_Bookmarks),
      fermium::SDL_SCANCODE_AC_FORWARD => Ok(Scancode::AC_Forward),
      fermium::SDL_SCANCODE_AC_HOME => Ok(Scancode::AC_Home),
      fermium::SDL_SCANCODE_AC_REFRESH => Ok(Scancode::AC_Refresh),
      fermium::SDL_SCANCODE_AC_SEARCH => Ok(Scancode::AC_Search),
      fermium::SDL_SCANCODE_AC_STOP => Ok(Scancode::AC_Stop),
      fermium::SDL_SCANCODE_AGAIN => Ok(Scancode::Again),
      fermium::SDL_SCANCODE_ALTERASE => Ok(Scancode::AltErase),
      fermium::SDL_SCANCODE_APOSTROPHE => Ok(Scancode::Apostrophe),
      fermium::SDL_SCANCODE_APP1 => Ok(Scancode::App1),
      fermium::SDL_SCANCODE_APP2 => Ok(Scancode::App2),
      fermium::SDL_SCANCODE_APPLICATION => Ok(Scancode::Application),
      fermium::SDL_SCANCODE_AUDIOFASTFORWARD => Ok(Scancode::AudioFastForward),
      fermium::SDL_SCANCODE_AUDIOMUTE => Ok(Scancode::AudioMute),
      fermium::SDL_SCANCODE_AUDIONEXT => Ok(Scancode::AudioNext),
      fermium::SDL_SCANCODE_AUDIOPLAY => Ok(Scancode::AudioPlay),
      fermium::SDL_SCANCODE_AUDIOPREV => Ok(Scancode::AudioPrev),
      fermium::SDL_SCANCODE_AUDIOREWIND => Ok(Scancode::AudioRewind),
      fermium::SDL_SCANCODE_AUDIOSTOP => Ok(Scancode::AudioStop),
      fermium::SDL_SCANCODE_B => Ok(Scancode::B),
      fermium::SDL_SCANCODE_BACKSLASH => Ok(Scancode::Backslash),
      fermium::SDL_SCANCODE_BACKSPACE => Ok(Scancode::Backspace),
      fermium::SDL_SCANCODE_BRIGHTNESSDOWN => Ok(Scancode::BrightnessDown),
      fermium::SDL_SCANCODE_BRIGHTNESSUP => Ok(Scancode::BrightnessUp),
      fermium::SDL_SCANCODE_C => Ok(Scancode::C),
      fermium::SDL_SCANCODE_CALCULATOR => Ok(Scancode::Calculator),
      fermium::SDL_SCANCODE_CANCEL => Ok(Scancode::Cancel),
      fermium::SDL_SCANCODE_CAPSLOCK => Ok(Scancode::CapsLock),
      fermium::SDL_SCANCODE_CLEAR => Ok(Scancode::Clear),
      fermium::SDL_SCANCODE_CLEARAGAIN => Ok(Scancode::ClearAgain),
      fermium::SDL_SCANCODE_COMMA => Ok(Scancode::Comma),
      fermium::SDL_SCANCODE_COMPUTER => Ok(Scancode::Computer),
      fermium::SDL_SCANCODE_COPY => Ok(Scancode::Copy),
      fermium::SDL_SCANCODE_CRSEL => Ok(Scancode::CrSel),
      fermium::SDL_SCANCODE_CURRENCYSUBUNIT => Ok(Scancode::CurrencySubUnit),
      fermium::SDL_SCANCODE_CURRENCYUNIT => Ok(Scancode::CurrencyUnit),
      fermium::SDL_SCANCODE_CUT => Ok(Scancode::Cut),
      fermium::SDL_SCANCODE_D => Ok(Scancode::D),
      fermium::SDL_SCANCODE_DECIMALSEPARATOR => Ok(Scancode::DecimalSeparator),
      fermium::SDL_SCANCODE_DELETE => Ok(Scancode::Delete),
      fermium::SDL_SCANCODE_DISPLAYSWITCH => Ok(Scancode::DisplaySwitch),
      fermium::SDL_SCANCODE_DOWN => Ok(Scancode::Down),
      fermium::SDL_SCANCODE_E => Ok(Scancode::E),
      fermium::SDL_SCANCODE_EJECT => Ok(Scancode::Eject),
      fermium::SDL_SCANCODE_END => Ok(Scancode::End),
      fermium::SDL_SCANCODE_EQUALS => Ok(Scancode::Equals),
      fermium::SDL_SCANCODE_ESCAPE => Ok(Scancode::Escape),
      fermium::SDL_SCANCODE_EXECUTE => Ok(Scancode::Execute),
      fermium::SDL_SCANCODE_EXSEL => Ok(Scancode::ExSel),
      fermium::SDL_SCANCODE_F => Ok(Scancode::F),
      fermium::SDL_SCANCODE_F1 => Ok(Scancode::F1),
      fermium::SDL_SCANCODE_F2 => Ok(Scancode::F2),
      fermium::SDL_SCANCODE_F3 => Ok(Scancode::F3),
      fermium::SDL_SCANCODE_F4 => Ok(Scancode::F4),
      fermium::SDL_SCANCODE_F5 => Ok(Scancode::F5),
      fermium::SDL_SCANCODE_F6 => Ok(Scancode::F6),
      fermium::SDL_SCANCODE_F7 => Ok(Scancode::F7),
      fermium::SDL_SCANCODE_F8 => Ok(Scancode::F8),
      fermium::SDL_SCANCODE_F9 => Ok(Scancode::F9),
      fermium::SDL_SCANCODE_F10 => Ok(Scancode::F10),
      fermium::SDL_SCANCODE_F11 => Ok(Scancode::F11),
      fermium::SDL_SCANCODE_F12 => Ok(Scancode::F12),
      fermium::SDL_SCANCODE_F13 => Ok(Scancode::F13),
      fermium::SDL_SCANCODE_F14 => Ok(Scancode::F14),
      fermium::SDL_SCANCODE_F15 => Ok(Scancode::F15),
      fermium::SDL_SCANCODE_F16 => Ok(Scancode::F16),
      fermium::SDL_SCANCODE_F17 => Ok(Scancode::F17),
      fermium::SDL_SCANCODE_F18 => Ok(Scancode::F18),
      fermium::SDL_SCANCODE_F19 => Ok(Scancode::F19),
      fermium::SDL_SCANCODE_F20 => Ok(Scancode::F20),
      fermium::SDL_SCANCODE_F21 => Ok(Scancode::F21),
      fermium::SDL_SCANCODE_F22 => Ok(Scancode::F22),
      fermium::SDL_SCANCODE_F23 => Ok(Scancode::F23),
      fermium::SDL_SCANCODE_F24 => Ok(Scancode::F24),
      fermium::SDL_SCANCODE_FIND => Ok(Scancode::Find),
      fermium::SDL_SCANCODE_G => Ok(Scancode::G),
      fermium::SDL_SCANCODE_GRAVE => Ok(Scancode::Grave),
      fermium::SDL_SCANCODE_H => Ok(Scancode::H),
      fermium::SDL_SCANCODE_HELP => Ok(Scancode::Help),
      fermium::SDL_SCANCODE_HOME => Ok(Scancode::Home),
      fermium::SDL_SCANCODE_I => Ok(Scancode::I),
      fermium::SDL_SCANCODE_INSERT => Ok(Scancode::Insert),
      fermium::SDL_SCANCODE_INTERNATIONAL1 => Ok(Scancode::International1),
      fermium::SDL_SCANCODE_INTERNATIONAL2 => Ok(Scancode::International2),
      fermium::SDL_SCANCODE_INTERNATIONAL3 => Ok(Scancode::International3),
      fermium::SDL_SCANCODE_INTERNATIONAL4 => Ok(Scancode::International4),
      fermium::SDL_SCANCODE_INTERNATIONAL5 => Ok(Scancode::International5),
      fermium::SDL_SCANCODE_INTERNATIONAL6 => Ok(Scancode::International6),
      fermium::SDL_SCANCODE_INTERNATIONAL7 => Ok(Scancode::International7),
      fermium::SDL_SCANCODE_INTERNATIONAL8 => Ok(Scancode::International8),
      fermium::SDL_SCANCODE_INTERNATIONAL9 => Ok(Scancode::International9),
      ...
      fermium::SDL_SCANCODE_KP_000 => Ok(Scancode::KP_000),
      fermium::SDL_SCANCODE_KP_1 => Ok(Scancode::KP_1),
      fermium::SDL_SCANCODE_KP_2 => Ok(Scancode::KP_2),
      fermium::SDL_SCANCODE_KP_3 => Ok(Scancode::KP_3),
      fermium::SDL_SCANCODE_KP_4 => Ok(Scancode::KP_4),
      fermium::SDL_SCANCODE_KP_5 => Ok(Scancode::KP_5),
      fermium::SDL_SCANCODE_KP_6 => Ok(Scancode::KP_6),
      fermium::SDL_SCANCODE_KP_7 => Ok(Scancode::KP_7),
      fermium::SDL_SCANCODE_KP_8 => Ok(Scancode::KP_8),
      fermium::SDL_SCANCODE_KP_9 => Ok(Scancode::KP_9),
      fermium::SDL_SCANCODE_KP_A => Ok(Scancode::KP_A),
      fermium::SDL_SCANCODE_KP_AMPERSAND => Ok(Scancode::KP_Ampersand),
      fermium::SDL_SCANCODE_KP_AT => Ok(Scancode::KP_At),
      fermium::SDL_SCANCODE_KP_B => Ok(Scancode::KP_B),
      fermium::SDL_SCANCODE_KP_BACKSPACE => Ok(Scancode::KP_Backspace),
      fermium::SDL_SCANCODE_KP_BINARY => Ok(Scancode::KP_Binary),
      fermium::SDL_SCANCODE_KP_C => Ok(Scancode::KP_C),
      fermium::SDL_SCANCODE_KP_CLEAR => Ok(Scancode::KP_Clear),
      fermium::SDL_SCANCODE_KP_CLEARENTRY => Ok(Scancode::KP_ClearEntry),
      fermium::SDL_SCANCODE_KP_COLON => Ok(Scancode::KP_Colon),
      ...
      fermium::SDL_SCANCODE_KP_ENTER => Ok(Scancode::KP_Enter),
      fermium::SDL_SCANCODE_KP_EQUALS => Ok(Scancode::KP_Equals),
      fermium::SDL_SCANCODE_KP_EQUALSAS400 => Ok(Scancode::KP_EqualsAs400),
      fermium::SDL_SCANCODE_KP_EXCLAM => Ok(Scancode::KP_Exclamation),
      fermium::SDL_SCANCODE_KP_F => Ok(Scancode::KP_F),
      fermium::SDL_SCANCODE_KP_GREATER => Ok(Scancode::KP_Greater),
      fermium::SDL_SCANCODE_KP_HASH => Ok(Scancode::KP_Hash),
      fermium::SDL_SCANCODE_KP_HEXADECIMAL => Ok(Scancode::KP_Hexadecimal),
      fermium::SDL_SCANCODE_KP_LEFTBRACE => Ok(Scancode::KP_LeftBrace),
      fermium::SDL_SCANCODE_KP_LEFTPAREN => Ok(Scancode::KP_LeftParen),
      fermium::SDL_SCANCODE_KP_LESS => Ok(Scancode::KP_Less),
      fermium::SDL_SCANCODE_KP_MEMADD => Ok(Scancode::KP_MemAdd),
      fermium::SDL_SCANCODE_KP_MEMCLEAR => Ok(Scancode::KP_MemClear),
      fermium::SDL_SCANCODE_KP_MEMDIVIDE => Ok(Scancode::KP_MemDivide),
      fermium::SDL_SCANCODE_KP_MEMMULTIPLY => Ok(Scancode::KP_MemMultiply),
      fermium::SDL_SCANCODE_KP_MEMRECALL => Ok(Scancode::KP_MemRecall),
      fermium::SDL_SCANCODE_KP_MEMSTORE => Ok(Scancode::KP_MemStore),
      fermium::SDL_SCANCODE_KP_MEMSUBTRACT => Ok(Scancode::KP_MemSubtract),
      fermium::SDL_SCANCODE_KP_MINUS => Ok(Scancode::KP_Minus),
      fermium::SDL_SCANCODE_KP_MULTIPLY => Ok(Scancode::KP_Multiply),
      fermium::SDL_SCANCODE_KP_OCTAL => Ok(Scancode::KP_Octal),
      fermium::SDL_SCANCODE_KP_PERCENT => Ok(Scancode::KP_Percent),
      fermium::SDL_SCANCODE_KP_PERIOD => Ok(Scancode::KP_Period),
      fermium::SDL_SCANCODE_KP_PLUS => Ok(Scancode::KP_Plus),
      fermium::SDL_SCANCODE_KP_PLUSMINUS => Ok(Scancode::KP_PlusMinus),
      fermium::SDL_SCANCODE_KP_POWER => Ok(Scancode::KP_Power),
      fermium::SDL_SCANCODE_KP_RIGHTBRACE => Ok(Scancode::KP_RightBrace),
      fermium::SDL_SCANCODE_KP_RIGHTPAREN => Ok(Scancode::KP_RightParen),
      fermium::SDL_SCANCODE_KP_SPACE => Ok(Scancode::KP_Space),
      fermium::SDL_SCANCODE_KP_TAB => Ok(Scancode::KP_Tab),
      fermium::SDL_SCANCODE_KP_VERTICALBAR => Ok(Scancode::KP_VerticalBar),
      fermium::SDL_SCANCODE_KP_XOR => Ok(Scancode::KP_Xor),
      fermium::SDL_SCANCODE_L => Ok(Scancode::L),
      fermium::SDL_SCANCODE_LALT => Ok(Scancode::LeftAlt),
      fermium::SDL_SCANCODE_LANG1 => Ok(Scancode::Lang1),
      fermium::SDL_SCANCODE_LANG2 => Ok(Scancode::Lang2),
      fermium::SDL_SCANCODE_LANG3 => Ok(Scancode::Lang3),
      fermium::SDL_SCANCODE_LANG4 => Ok(Scancode::Lang4),
      fermium::SDL_SCANCODE_LANG5 => Ok(Scancode::Lang5),
      fermium::SDL_SCANCODE_LANG6 => Ok(Scancode::Lang6),
      fermium::SDL_SCANCODE_LANG7 => Ok(Scancode::Lang7),
      fermium::SDL_SCANCODE_LANG8 => Ok(Scancode::Lang8),
      fermium::SDL_SCANCODE_LANG9 => Ok(Scancode::Lang9),
      fermium::SDL_SCANCODE_LCTRL => Ok(Scancode::LeftCtrl),
      fermium::SDL_SCANCODE_LEFT => Ok(Scancode::Left),
      fermium::SDL_SCANCODE_LEFTBRACKET => Ok(Scancode::LeftBracket),
      fermium::SDL_SCANCODE_LGUI => Ok(Scancode::LeftGUI),
      fermium::SDL_SCANCODE_LSHIFT => Ok(Scancode::LeftShift),
      fermium::SDL_SCANCODE_M => Ok(Scancode::M),
      fermium::SDL_SCANCODE_MAIL => Ok(Scancode::Mail),
      fermium::SDL_SCANCODE_MEDIASELECT => Ok(Scancode::Mediaselect),
      fermium::SDL_SCANCODE_MENU => Ok(Scancode::Menu),
      fermium::SDL_SCANCODE_MINUS => Ok(Scancode::Minus),
      fermium::SDL_SCANCODE_MODE => Ok(Scancode::Mode),
      fermium::SDL_SCANCODE_MUTE => Ok(Scancode::Mute),
      fermium::SDL_SCANCODE_N => Ok(Scancode::N),
      fermium::SDL_SCANCODE_NONUSBACKSLASH => Ok(Scancode::NonUSBackslash),
      fermium::SDL_SCANCODE_NONUSHASH => Ok(Scancode::NonUSHash),
      fermium::SDL_SCANCODE_NUMLOCKCLEAR => Ok(Scancode::NumLockClear),
      fermium::SDL_SCANCODE_O => Ok(Scancode::O),
      fermium::SDL_SCANCODE_OPER => Ok(Scancode::Oper),
      fermium::SDL_SCANCODE_OUT => Ok(Scancode::Out),
      fermium::SDL_SCANCODE_P => Ok(Scancode::P),
      fermium::SDL_SCANCODE_PAGEDOWN => Ok(Scancode::PageDown),
      fermium::SDL_SCANCODE_PAGEUP => Ok(Scancode::PageUp),
      fermium::SDL_SCANCODE_PASTE => Ok(Scancode::Paste),
      fermium::SDL_SCANCODE_PAUSE => Ok(Scancode::Pause),
      fermium::SDL_SCANCODE_PERIOD => Ok(Scancode::Period),
      fermium::SDL_SCANCODE_POWER => Ok(Scancode::Power),
      fermium::SDL_SCANCODE_PRINTSCREEN => Ok(Scancode::PrintScreen),
      fermium::SDL_SCANCODE_PRIOR => Ok(Scancode::Prior),
      fermium::SDL_SCANCODE_Q => Ok(Scancode::Q),
      fermium::SDL_SCANCODE_R => Ok(Scancode::R),
      fermium::SDL_SCANCODE_RALT => Ok(Scancode::RightAlt),
      fermium::SDL_SCANCODE_RCTRL => Ok(Scancode::RightCtrl),
      fermium::SDL_SCANCODE_RETURN => Ok(Scancode::Return),
      fermium::SDL_SCANCODE_RETURN2 => Ok(Scancode::Return2),
      fermium::SDL_SCANCODE_RGUI => Ok(Scancode::RightGUI),
      fermium::SDL_SCANCODE_RIGHT => Ok(Scancode::Right),
      fermium::SDL_SCANCODE_RIGHTBRACKET => Ok(Scancode::RightBracket),
      fermium::SDL_SCANCODE_RSHIFT => Ok(Scancode::RightShift),
      fermium::SDL_SCANCODE_S => Ok(Scancode::S),
      fermium::SDL_SCANCODE_SCROLLLOCK => Ok(Scancode::ScrollLock),
      fermium::SDL_SCANCODE_SELECT => Ok(Scancode::Select),
      fermium::SDL_SCANCODE_SEMICOLON => Ok(Scancode::Semicolon),
      fermium::SDL_SCANCODE_SEPARATOR => Ok(Scancode::Separator),
      fermium::SDL_SCANCODE_SLASH => Ok(Scancode::Slash),
      fermium::SDL_SCANCODE_SLEEP => Ok(Scancode::Sleep),
      fermium::SDL_SCANCODE_SPACE => Ok(Scancode::Space),
      fermium::SDL_SCANCODE_STOP => Ok(Scancode::Stop),
      ...
      fermium::SDL_SCANCODE_UP => Ok(Scancode::Up),
      fermium::SDL_SCANCODE_V => Ok(Scancode::V),
      fermium::SDL_SCANCODE_VOLUMEDOWN => Ok(Scancode::VolumeDown),
      fermium::SDL_SCANCODE_VOLUMEUP => Ok(Scancode::VolumeUp),
      fermium::SDL_SCANCODE_W => Ok(Scancode::W),
      fermium::SDL_SCANCODE_WWW => Ok(Scancode::WWW),
      fermium::SDL_SCANCODE_X => Ok(Scancode::X),
      fermium::SDL_SCANCODE_Y => Ok(Scancode::Y),
      fermium::SDL_SCANCODE_Z => Ok(Scancode::Z),
      _ => Err(()),
    }
  }
}
...
const KEY_MODIFIER_CAPS: u16 = fermium::KMOD_CAPS as u16;
const KEY_MODIFIER_LALT: u16 = fermium::KMOD_LALT as u16;
const KEY_MODIFIER_LCTRL: u16 = fermium::KMOD_LCTRL as u16;
const KEY_MODIFIER_LGUI: u16 = fermium::KMOD_LGUI as u16;
const KEY_MODIFIER_LSHIFT: u16 = fermium::KMOD_LSHIFT as u16;
const KEY_MODIFIER_MODE: u16 = fermium::KMOD_MODE as u16;
const KEY_MODIFIER_NUM: u16 = fermium::KMOD_NUM as u16;
const KEY_MODIFIER_RALT: u16 = fermium::KMOD_RALT as u16;
const KEY_MODIFIER_RCTRL: u16 = fermium::KMOD_RCTRL as u16;
const KEY_MODIFIER_RGUI: u16 = fermium::KMOD_RGUI as u16;
const KEY_MODIFIER_RSHIFT: u16 = fermium::KMOD_RSHIFT as u16;
